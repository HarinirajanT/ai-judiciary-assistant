...
const JudgeDashboard = () => {
    ...
    const fetchJudgeDashboardData = async () => {
        try {
            ...
            const casesRes = await fetch(`${API_BASE}/cases/all`, {
                headers: {
    ...
    const submitVerdict = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/cases/${selectedCase._id}`, {
                method: "PUT",
                headers: {
                    "Authorization": `Bearer ${token}`,
                    "Content-Type": "application/json"
                                    ...
                                    <div className="files-list">
                                        {selectedCase.uploadedFiles.map((file, index) => (
                                            <div key={index} className="file-item">
                                                ...
                                                <button
                                                    className="btn btn-sm btn-primary"
                                                    onClick={() => openDocumentViewer(`${API_BASE}/cases/file/${selectedCase._id}/${encodeURIComponent(file)}`, file)}
